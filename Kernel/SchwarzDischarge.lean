...
-- f_modif of hurwitzEvenFEPair 0 is real-valued (conj-fixed)
lemma fmodif_conj_fixed (t : ℝ) :
...
-- =========================================================
-- MAIN THEOREM: Schwarz reflection for completed zeta
-- =========================================================
