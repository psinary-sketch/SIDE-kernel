/-
Copyright (c) 2026 PLACE TO STAND Research Programme. All rights reserved.
Released under Apache 2.0 license as described in the file LICENSE.
Authors: PLACE TO STAND Research Programme
-/
...
private lemma conj_ofReal_two : (starRingEnd ℂ) (2 : ℂ) = 2 :=
  by exact_mod_cast conj_ofReal 2
...
theorem completedRiemannZeta₀_conj (s : ℂ) :
  ...
  calc ∫ t in Ioi (0 : ℝ), (↑t : ℂ) ^ ((starRingEnd ℂ) s / 2 - 1) •
      ...
      = ∫ t in Ioi (0 : ℝ), (starRingEnd ℂ) ((↑t : ℂ) ^ (s / 2 - 1) •
        (hurwitzEvenFEPair 0).f_modif t) :=
          setIntegral_congr_fun measurableSet_Ioi hpt
...
theorem completedRiemannZeta₀_conj_eq_self_on_half (t : ℝ) :
    (starRingEnd ℂ) (completedRiemannZeta₀ ⟨1/2, t⟩) =
    completedRiemannZeta₀ ⟨1/2, t⟩ := by
